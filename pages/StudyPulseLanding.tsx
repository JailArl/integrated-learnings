...
const T = {
  ...
  priceSub: { en: 'Start free. Upgrade when you want daily visibility.', zh: '免费开始。想要每天了解情况时再升级。' },
  ...
  priceBubble: { en: 'Less than 2 bubble teas', zh: '不到两杯奶茶的价格' },
  priceStartFree: { en: 'Start Free', zh: '免费开始' },
  priceGetPrem: { en: 'Get Premium', zh: '立即升级' },
  pricePaynow: { en: 'Pay via PayNow. No auto-renewal. Cancel anytime.', zh: '通过 PayNow 付款。不自动续费。随时取消。' },
  ...
  faqs: {
    ...
    zh: [
      ...
      { q: '可以随时取消或降级吗？', a: '可以。没有锁定期、没有合约、不自动续费。通过 PayNow 按月付款，想停就停。' },
