        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-x-5 gap-y-3 text-sm text-slate-300">
              <span className="flex items-center"><ShieldCheck size={15} className="mr-2 text-emerald-300" aria-hidden="true" />Verified &amp; Background-Checked</span>
              <span className="flex items-center"><RefreshCw size={15} className="mr-2 text-emerald-300" aria-hidden="true" />Free Replacement if Not a Fit</span>
              <span className="flex items-center"><BadgeCheck size={15} className="mr-2 text-emerald-300" aria-hidden="true" />No Lock-in Contract</span>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur-xl md:p-7">
            ...
            <div className="mt-5 space-y-4">
              <div className="rounded-xl border border-white/15 bg-slate-900/30 p-4">
                <p className="text-sm font-bold text-white flex items-center"><Clock3 size={16} className="mr-2 text-blue-300" aria-hidden="true" /> How fast?</p>
                <p className="mt-1 text-sm text-slate-300">Most families are matched within 2&ndash;3 business days.</p>
              </div>
              <div className="rounded-xl border border-white/15 bg-slate-900/30 p-4">
                <p className="text-sm font-bold text-white flex items-center"><LineChart size={16} className="mr-2 text-blue-300" aria-hidden="true" /> How much?</p>
              ...
              <div className="rounded-xl border border-white/15 bg-slate-900/30 p-4">
                <p className="text-sm font-bold text-white flex items-center"><ShieldCheck size={16} className="mr-2 text-blue-300" aria-hidden="true" /> What if it doesn&rsquo;t work?</p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={item.title} className="relative rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
                ...
                <item.icon size={22} className="mb-3 text-blue-600" aria-hidden="true" />
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-start text-sm text-slate-600">
                    <X size={16} className="mr-3 mt-0.5 flex-shrink-0 text-slate-400" aria-hidden="true" />
                    {item}
                  </li>
                ))}
              </ul>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-start text-sm text-slate-700">
                    <CheckCircle2 size={16} className="mr-3 mt-0.5 flex-shrink-0 text-blue-600" aria-hidden="true" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            {faqs.map((faq, idx) => (
              <div key={idx} className="overflow-hidden rounded-xl border border-slate-200 bg-white">
                ...
                >
                  ...
                  <ChevronDown size={18} className={`ml-4 flex-shrink-0 transition ${openFaq === idx ? 'rotate-180' : ''}`} aria-hidden="true" />
                </button>
                {openFaq === idx && (
                  <div
                    id={`tuition-faq-${idx}`}
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-6 flex flex-col items-center gap-2 text-center text-xs text-slate-500">
            <div className="flex flex-wrap justify-center gap-x-5 gap-y-2">
              <span className="flex items-center"><ShieldCheck size={13} className="mr-1.5 text-slate-400" aria-hidden="true" />Your information is kept confidential</span>
              <span className="flex items-center"><CheckCircle2 size={13} className="mr-1.5 text-slate-400" aria-hidden="true" />No spam &mdash; we only contact you about your inquiry</span>
              <span className="flex items-center"><BadgeCheck size={13} className="mr-1.5 text-slate-400" aria-hidden="true" />Free to submit. You only pay when lessons begin.</span>
            </div>
          </div>
        </div>
      </Section>
