...
const MainLanding: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-900 to-slate-900 flex flex-col text-white">
      {/* Hero Section */}
      <section aria-labelledby="hero-heading" className="flex-1 flex items-center justify-center px-4 py-20 relative overflow-hidden">
        {/* Animated Background */}
        ...
        <div className="max-w-5xl w-full relative z-10">
          <div className="text-center mb-12">
            <h1 id="hero-heading" className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-8 leading-tight">
      ...
      {/* Why We Exist */}
      <section aria-labelledby="values-heading" className="bg-gradient-to-r from-blue-900 via-slate-900 to-slate-900 px-4 py-20">
        <div className="max-w-5xl mx-auto">
          <h2 id="values-heading" className="sr-only">Our Vision, Mission, and Values</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {/* Vision */}
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
              <Heart className="w-12 h-12 text-blue-300 mb-4" aria-hidden="true" />
            ...
            {/* Mission */}
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
              <Lightbulb className="w-12 h-12 text-blue-300 mb-4" aria-hidden="true" />
            ...
            {/* Values */}
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
              <Users className="w-12 h-12 text-blue-300 mb-4" aria-hidden="true" />
